...
from ldm.models.mile.constants import CARLA_FPS, DISPLAY_SEGMENTATION
from ldm.models.mile.utils.network_utils import pack_sequence_dim, unpack_sequence_dim, remove_past
from ldm.models.mile.models.common import BevDecoder, Decoder, RouteEncode, Policy
from ldm.models.mile.models.frustum_pooling import FrustumPooling
from ldm.models.mile.layers.layers import BasicBlock
from ldm.models.mile.models.transition import RSSM
...
class Mile(nn.Module):
    def __init__(self,cfg):
        ...
        if cfg['MODEL']['ENCODER']['NAME'] == 'resnet18':
        ...
        self.speed_enc = nn.Sequential(
            nn.Linear(3,cfg['MODEL']['SPEED']['CHANNELS']),
            nn.ReLU(True),
        ...
        # Recurrent model
        self.receptive_filed = self.cfg['RECEPTIVE_FIELD']
    ...
    def encode(self,batch):
        ...
        speed_features = speed / self.speed_normalization
        speed_features = self.speed_enc(speed_features)
    ...
    def observe_and_imagine(self,batch,predict_action=False,feature_horizon=None):
        ...
        if not predict_action:
            assert batch['accel'].shape[1] == s + future_horizon
            assert batch['orientation'].shape[1] == s + future_horizon
