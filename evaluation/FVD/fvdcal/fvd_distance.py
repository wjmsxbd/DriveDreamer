...
class FVDCalculation:
    def __init__(self, method: str = 'videogpt', frame_sample_strategy: str = 'start',n_sample=2048):
        self.method = method
    ...
    def _load_model(self, model_path: str, device: torch.device, num_classes: int = 400):
        if self.method == 'videogpt':
            ...
            with open(os.path.join('evaluation/FVD',model_path, 'stylegan', "i3d_torchscript.pt"), 'rb') as f:
