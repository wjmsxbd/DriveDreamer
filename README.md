...
修改configs/video_decoder.yaml中的数据集version和path
'
python main.py --base configs/video_decoder.yaml --train True
'
...
`
`
python main.py --base configs/prediction4.yaml --train True
`
