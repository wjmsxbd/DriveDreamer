...
class VideoResnetBlock(ResnetBlock):
    def __init__(self,in_channels,out_channels=None,temb_channels=512,num_groups=32,dropout=0.,merge_strategy='learned',alpha=0.0,movie_len=None,video_kernel_size=3,):
